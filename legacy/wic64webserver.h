...
void handleUpdate() {
  ...
  t_httpUpdate_return ret = httpUpdate.update(client, "http://wic64.com:80/firmware/stable/wic64.bin");
...
void handleDeveloper() {
  ...
  t_httpUpdate_return ret = httpUpdate.update(client, "http://wic64.com:80/firmware/test/wic64.bin");
...
void handleDeveloper2() {
  ...
  t_httpUpdate_return ret = httpUpdate.update(client, "http://wic64.com:80/firmware/test/wic64.bin?" + tempmac);
...
void handleDowngrade() {
  ...
  t_httpUpdate_return ret = httpUpdate.update(client, "http://wic64.com:80/firmware/stable/wic64-old.bin");
