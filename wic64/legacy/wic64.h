...
String fwvHEX;        // firmwareversion output in HEX
...
void WiC64connected(WiFiEvent_t event, WiFiEventInfo_t info) {
  displaystuff("WiFi reconnect");
}
void WiC64disconnected(WiFiEvent_t event, WiFiEventInfo_t info) {
  displaystuff("WiFi conn lost");
  WiFi.begin();
}
